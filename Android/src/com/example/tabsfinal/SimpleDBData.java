...
public class SimpleDBData {	
	...
	private static final String LISTINGS_DOMAIN = "DBList";
	
	private static final String USER_ATTRIBUTE = "player"; //Not sure what this might fuck up so Im not gonna change it to "users" as it should be
	private static final String VENUE_ATTRIBUTE = "score";
	...
	public void addHighScore( Listing score ) {
		//String paddedScore = SimpleDBUtils.encodeZeroPadding( score.getUser(), 10 );
		...
		ReplaceableAttribute scoreAttribute = new ReplaceableAttribute( VENUE_ATTRIBUTE, paddedScore, Boolean.TRUE );
