package io.swipeswap.messaging;
...
public class ConversationActivity extends FragmentActivity {
	...
	@Override
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        setContentView(io.swipeswap.R.layout.conversation_activity);
	 
	        now = new Time();
	        final EditText message_content_holder = (EditText) findViewById(io.swipeswap.R.id.messageEdit);
	        Intent i = getIntent();
	        int pos = 0;
	        ...
	        RelativeLayout close = (RelativeLayout) findViewById(io.swipeswap.R.id.go_back);
	        ...
	        close.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					finish();
					overridePendingTransition(io.swipeswap.R.anim.slide_in_from_left, io.swipeswap.R.anim.slide_out_to_right);
					
				}
			});
	        
	        
	     	submit_message = (Button) findViewById(io.swipeswap.R.id.chatSendButton);
	        ...
	        fm.beginTransaction().add(io.swipeswap.R.id.conversation_view, frag).commit();
	   ...
	   public void refreshConversationFragment(Message m, boolean update_list) {
		   Fragment fragment = this.getSupportFragmentManager().findFragmentById(io.swipeswap.R.id.conversation_view);
		   if(fragment != null)
		   {
