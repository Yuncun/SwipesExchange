...
public class ConversationFragment extends ListFragment {
	...
	public ConversationFragment(ArrayList<Message> l) {
     ...
     public View onCreateView(LayoutInflater inflater, ViewGroup container,
         ...
         View view = inflater.inflate(io.swipeswap.R.layout.conversation_fragment_list, container, false);
         if(getActivity() != null && getActivity().getActionBar() != null && getActivity().getCallingActivity() != null)
